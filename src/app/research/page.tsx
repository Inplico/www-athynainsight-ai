          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="relative flex flex-col bg-white border border-dashed border-slate-200 rounded-2xl p-10 min-h-[380px] opacity-90">
              <div className="flex justify-between items-start mb-7">
                ...
                <span className="text-4xl font-bold text-slate-200 tracking-[-0.04em] leading-none">04</span>
              </div>
              ...
              <div className="text-sm leading-relaxed text-slate-500 bg-slate-50 rounded-xl p-4 mb-6 flex-1">
                Regulatory intelligence as a distinct layer within the building ecosystem &mdash; aligning policy, design, and execution at scale.
              </div>
